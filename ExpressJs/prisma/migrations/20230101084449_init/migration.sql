...
-- AddForeignKey
ALTER TABLE "UpdatePoint" ADD CONSTRAINT "UpdatePoint_uppateId_fkey" FOREIGN KEY ("uppateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
